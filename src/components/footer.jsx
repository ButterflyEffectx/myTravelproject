        ...
        <div className="py-6 bg-slate-800">
            <div className="container mx-auto">
                ...
                <div className="flex py-8 space-x-[3rem] text-black text-3xl justify-center">
                    <Link><FontAwesomeIcon icon={faFacebook} className='bg-white p-3 rounded-full'/></Link>
                    <Link><FontAwesomeIcon icon={faLine} className='bg-white p-3 rounded-full'/></Link>
                    <Link><FontAwesomeIcon icon={faSquareFontAwesomeStroke} className='bg-white p-3 rounded-full'/></Link>
                </div>
